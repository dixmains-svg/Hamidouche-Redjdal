...
def generer_pdf(filename="cv_hamidouche_redjdal.pdf"):
    """Génère un fichier PDF propre et lisible à partir des données du CV."""
...
# Génération automatique du fichier PDF s'il n'existe pas
...
# LECTURE ET BOUTON DE TÉLÉCHARGEMENT
